...
<form method="POST" action="/register" enctype="multipart/form-data">
    @csrf
	<input class="regist" type="text" name="fName" placeholder="First Name" required value="{{old('firstName')}}"><br>
	<input class="regist" type="text" name="lName" placeholder="Last Name" required value="{{old('lastName')}}"><br>
